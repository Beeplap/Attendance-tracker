          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-3 rounded-lg bg-purple-50 dark:bg-purple-900/30">
                <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">32</p>
              ...
              <div className="p-3 rounded-lg bg-red-50 dark:bg-red-900/30">
                <p className="text-3xl font-bold text-red-500 dark:text-red-400">4</p>
              ...
              <table className="min-w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-purple-100 dark:divide-purple-800">
                  <tr className="hover:bg-purple-50 dark:hover:bg-purple-900/30 transition">
                    <td className="p-3 flex items-center gap-2 text-purple-700 dark:text-purple-300"><BookOpen size={16}/> Mathematics</td>
                  ...
                  <tr className="hover:bg-purple-50 dark:hover:bg-purple-900/30 transition">
                    <td className="p-3 flex items-center gap-2 text-violet-700 dark:text-violet-300"><BookOpen size={16}/> Science</td>
                  ...
                  <tr className="hover:bg-purple-50 dark:hover:bg-purple-900/30 transition">
                    <td className="p-3 flex items-center gap-2 text-purple-700 dark:text-purple-300"><BookOpen size={16}/> Computer</td>
